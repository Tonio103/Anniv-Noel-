...
export const STATIONS = [
  ...
  /* ---------------------------------------------------------------- 3 */
  {
    ...
    card: {
      ...
      title: 'De la déco',
      price: { amount: '15 €', note: 'environ, cadre + plantes' },
      blocks: [
        { t: 'lead', h: 'Deux choses pour habiller la chambre&nbsp;: un <strong>cadre en bois</strong> et deux petites <strong>plantes grasses</strong>.' },
        { t: 'faits', items: [
          { k: 'Cadre', v: 'IKEA — <em>modèle simple, bois</em>' },
          { k: 'Prix', v: '<b>≈ 10 €</b> selon la taille' },
          { k: 'Plantes', v: 'deux petites plantes grasses' },
          { k: 'Où', v: 'Plantes Pour Tous' },
          { k: 'Prix', v: '<b>≈ 4 à 10 €</b> les deux' },
        ]},
        { t: 'p', h: 'Un cadre nu, sobre, en bois — un modèle simple du rayon cadres suffit très bien, pas besoin de chercher plus compliqué. Les plantes grasses demandent presque aucun entretien, parfait pour une chambre.' },
        { t: 'note', h: '<b>Prix à vérifier sur place&nbsp;:</b> IKEA et Plantes Pour Tous n’étaient pas joignables pour relever un prix exact — les montants ci-dessus sont des ordres de grandeur.' },
        { t: 'links', items: [
          { href: 'https://www.ikea.com/fr/fr/cat/cadres-passe-partouts-10777/', label: 'Cadres en bois', sub: 'IKEA' },
          { href: 'https://plantespourtous.co/', label: 'Plantes Pour Tous', sub: 'plantes grasses' },
        ]},
      ],
      next: 'Suivre le cerf',
    },
  ...
  /* ---------------------------------------------------------------- 4 */
  {
    ...
    card: {
      ...
      blocks: [
        ...
        { t: 'note', tone: 'good', h: '<b>La solution :</b> 80 € en liquide, mis de côté, que j’utiliserai moi-même le jour de la sortie PC.' },
        { t: 'note', tone: 'warn', h: '<b>À savoir pour plus tard :</b> il n’existe aujourd’hui aucune « clé PC GTA 6 » officielle — tout ce qui se vend sous ce nom est une arnaque.' },
      ],
      next: 'Suivre le cerf',
    },
  },
  ...
  /* ---------------------------------------------------------------- 5 */
  {
    ...
    card: {
      ...
      title: 'Un écran',
      price: { amount: '≈ 250 €', note: 'neuf, au Black Friday' },
      blocks: [
        { t: 'lead', h: 'Le gros morceau&nbsp;: de la <strong>4K en 120&nbsp;Hz minimum</strong>, achetée <strong>neuve sur Amazon</strong> — pas de reconditionné, pas d’occasion cette fois.' },
        { t: 'note', tone: 'good', h: '<b>Neuf uniquement, sur Amazon.</b> C’est ce qui a été demandé — pas de reconditionné ni d’occasion.' },
        { t: 'note', tone: 'good', h: '<b>Viser le Black Friday (27&nbsp;nov.) ou le Cyber Monday (30&nbsp;nov.).</b> C’est le seul moment de l’année où ce genre d’écran neuf baisse vraiment de prix.' },
        { t: 'faits', items: [
          { k: 'Cible', v: '4K · 120&nbsp;Hz minimum · DisplayPort' },
          { k: 'Modèle visé', v: 'AOC U27G4R — 4K 160&nbsp;Hz' },
          { k: 'Prix neuf', v: '<b>≈ 280 €</b> hors promotion' },
          { k: 'Prix visé', v: '<b>≈ 230 à 250 €</b> au Black Friday / Cyber Monday' },
          { k: 'Où', v: 'Amazon — <b>neuf uniquement</b>' },
        ]},
        { t: 'links', items: [
          { href: 'https://www.amazon.fr/s?k=AOC+U27G4R', label: 'AOC U27G4R neuf', sub: '4K 160&nbsp;Hz, ≈ 280 €' },
          { href: 'https://www.amazon.fr/s?k=ecran+4k+120hz+neuf', label: 'Autres écrans 4K neufs', sub: 'Amazon' },
        ]},
      ],
      next: 'Suivre le cerf',
    },
  ...
  /* ---------------------------------------------------------------- 7 */
  {
    ...
    card: {
      ...
      title: 'Le bon plan',
      blocks: [
        { t: 'note', tone: 'good', h: '<b>✓ L’écran — neuf sur Amazon.</b> L’AOC U27G4R à 280 € pourrait descendre autour de 230–250 € au <b>Black Friday</b> (27&nbsp;nov.) ou au <b>Cyber&nbsp;Monday</b> (30&nbsp;nov.) — c’est le moment d’acheter, pas avant.' },
  ...
  /* ---------------------------------------------------------------- 8 */
  {
    ...
    card: {
      ...
      blocks: [
        ...
        { t: 'p', h: 'Prix relevés début août 2026, à revérifier avant d’acheter.' },
        { t: 'p', h: 'À très vite&nbsp;✦' },
      ],
...
export const CHECKLIST = [
  ...
  { id: 'deco', t: 'Déco : cadre + plantes grasses', p: '≈ 15 €',
    d: 'Cadre en bois, modèle simple (IKEA, ≈ 10 €) · deux petites plantes grasses (Plantes Pour Tous, ≈ 4 à 10 € les deux).' },
  { id: 'gta', t: 'GTA 6', p: '80 €',
    d: '80 € en liquide, à donner directement — aucune version PC annoncée (sortie le 19 novembre 2026 sur PS5/Xbox Series seulement), à utiliser le jour de la sortie PC.' },
  { id: 'ecran', t: 'Écran 4K 120 Hz', p: '≈ 250 €',
    d: 'Neuf sur Amazon uniquement (pas de reconditionné) — viser le Black Friday (27 nov.) ou le Cyber Monday (30 nov.). AOC U27G4R, ≈ 280 € hors promo.' },
];
